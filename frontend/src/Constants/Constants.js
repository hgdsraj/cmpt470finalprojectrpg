...
const NUMERIC_CONSTANTS = {
  ...
  CREATE_CHARACTER_MIN_STAT_VALUE_STAM: 12,
  CREATE_CHARACTER_MIN_STAT_VALUE_STR: 10,
  CREATE_CHARACTER_MIN_STAT_VALUE_AGI: 10,
  CREATE_CHARACTER_MIN_STAT_VALUE_WIS: 11,
  CREATE_CHARACTER_MIN_STAT_VALUE_CHAR: 11,
  CREATE_CHARACTER_MAX_STAT_VALUE_STAM: 16,
  CREATE_CHARACTER_MAX_STAT_VALUE_STR: 14,
  CREATE_CHARACTER_MAX_STAT_VALUE_AGI: 14,
  CREATE_CHARACTER_MAX_STAT_VALUE_WIS: 15,
  CREATE_CHARACTER_MAX_STAT_VALUE_CHAR: 15,
};
